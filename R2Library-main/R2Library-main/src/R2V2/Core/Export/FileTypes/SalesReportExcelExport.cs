...
{
    public class SalesReportExcelExport : ExcelBase
    {
        public SalesReportExcelExport(SalesReportItems salesReportItems)
        {
            ...
            foreach (var item in salesReportItems.Items)
            {
