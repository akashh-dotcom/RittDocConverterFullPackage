...
'1_' + FORMAT(CAST(LEFT(CAST(CAST(CRYPT_GEN_RANDOM(3) as int) as varchar), 6) as int), '000000')
FROM tUser
...
INSERT INTO tUser
SELECT 'ASPAN', 'USER', pg.userName, pg.[password], 'aspan@rittenhouse.com', 0, 0, 0, i.iInstitutionId, r.iRoleId, NULL, 'Squish #1214', GETDATE(), NULL, NULL, 1, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL, 0, 0, 0, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL
FROM @PasswordGen pg
