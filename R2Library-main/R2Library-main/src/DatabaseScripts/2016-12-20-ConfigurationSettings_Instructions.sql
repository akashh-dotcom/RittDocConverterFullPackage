...
--select * from tConfigurationSetting where vchKey = 'R2ReportsConnectionString'
Update tConfigurationSetting set vchInstructions = 'string value - connection string for the R2Reports database.'
...
select vchSetting from tConfigurationSetting
where vchSetting not in ('Web', 'dev', 'admin', 'cache', 'client', 'CollectionManagement', 'Content', 'Email',
'Flowplayer', 'Image', 'IndexTermHighlight', 'Institution', 'Ooyala', 'TabersTermHighlight', 'MessageQueue'
, 'R2Utilities', 'WebImage','WindowsService') group by vchSetting
