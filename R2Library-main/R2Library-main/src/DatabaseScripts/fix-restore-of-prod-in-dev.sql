/****** Object: View [dbo].[vDailySearchCount]   Script Date: 4/18/2017 11:53:11 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vDailySearchCount]'))
BEGIN
...
CREATE VIEW [dbo].[vDailySearchCount] AS 
    ...
    where  s.searchTimestamp >  '04/01/2017 00:00:00' 
...
/****** Object: View [dbo].[vDailyPageViewCount]   Script Date: 4/18/2017 11:53:12 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vDailyPageViewCount]'))
BEGIN
...
CREATE VIEW [dbo].[vDailyPageViewCount] AS 
    ...
    where  pageViewTimestamp > '04/01/2017 00:00:00' 
...
/****** Object: View [dbo].[vContentView]   Script Date: 4/18/2017 11:53:12 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vContentView]'))
BEGIN
...
/****** Object: View [dbo].[vInstitutionStatistics]   Script Date: 4/18/2017 11:53:12 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vInstitutionStatistics]'))
BEGIN
...
/****** Object: View [dbo].[vInstitutionResourceStatistics]   Script Date: 4/18/2017 11:53:13 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vInstitutionResourceStatistics]'))
BEGIN
...
/****** Object: View [dbo].[vPageContentView]   Script Date: 4/18/2017 11:53:14 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vPageContentView]'))
BEGIN
...
/****** Object: View [dbo].[vPageView]   Script Date: 4/18/2017 11:53:14 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vPageView]'))
BEGIN
...
/****** Object: View [dbo].[vDailySessionCount]   Script Date: 4/18/2017 11:53:14 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vDailySessionCount]'))
BEGIN
...
/****** Object: View [dbo].[vDailyContentTurnawayCount]   Script Date: 4/18/2017 11:53:14 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vDailyContentTurnawayCount]'))
BEGIN
...
CREATE VIEW [dbo].[vDailyContentTurnawayCount] AS 
    ...
    where  turnawayTypeId <> 0 
      and  contentViewTimestamp > '04/01/2017 00:00:00' 
...
/****** Object: View [dbo].[vDailyInstitutionResourceStatisticsCount]   Script Date: 4/18/2017 11:53:14 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vDailyInstitutionResourceStatisticsCount]'))
BEGIN
...
/****** Object: View [dbo].[vDailyContentViewCount]   Script Date: 4/18/2017 11:53:14 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vDailyContentViewCount]'))
BEGIN
...
/****** Object: View [dbo].[vDailyResourceSessionCount]   Script Date: 4/18/2017 11:53:14 AM ******/
USE [DEV_RIT001];
GO
SET ANSI_NULLS ON;
GO
...
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vDailyResourceSessionCount]'))
BEGIN
