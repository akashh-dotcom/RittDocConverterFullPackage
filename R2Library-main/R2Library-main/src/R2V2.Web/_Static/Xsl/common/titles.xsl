...
<!-- 20-04-2006 common\titles.xsl	Updated for Glossary heading appearing extra while "Glossary" text present in its parent title -->
    <xsl:when test="contains(translate(parent::*/title,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'glossary')">
    </xsl:when>
    <xsl:otherwise>
