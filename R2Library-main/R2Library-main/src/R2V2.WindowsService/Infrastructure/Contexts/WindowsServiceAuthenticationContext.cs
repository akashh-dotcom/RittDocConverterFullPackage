...
namespace R2V2.WindowsService.Infrastructure.Contexts
{
    public class WindowsServiceAuthenticationContext : IAuthenticationContext
    {
        private readonly Func<IApplicationWideStorageService> _applicationWideStorageServiceFactory;

        public WindowsServiceAuthenticationContext(
            Func<IApplicationWideStorageService> applicationWideStorageServiceFactory)
        {
