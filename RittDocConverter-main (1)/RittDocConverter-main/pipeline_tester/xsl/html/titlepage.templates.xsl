...
<!-- 
History:
(01) **26-06-2008 (remove hr line if ancestor appendix is present before bibliography)
(02) **17-11-09 Added for Glossary author 
-->
...
<!--  <xsl:call-template name="component.title">
  ...
  <xsl:choose>
    <xsl:when test="title">
      <h2 class="title">
        <xsl:apply-templates mode="dedication.titlepage.recto.auto.mode" select="./title"/>        
      </h2>
    </xsl:when>
...
<!-- Remove for glossary author 17-11-09 -->
...
<xsl:when test="glossaryinfo/title">
      <xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/title"/>
    </xsl:when>
	...
	<xsl:when test="title">
      <xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
-->
...
<xsl:when test="glossaryinfo/title">
      <xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/title"/>
            ...
            <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
<xsl:when test="info/title">
      <xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/title"/>
    </xsl:when>
<xsl:when test="title">
      <xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="title"/>
    </xsl:when> 
...
<!-- Added for Glossary author 17-11-09 -->
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/corpauthor"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/corpauthor"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/corpauthor"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/authorgroup"/> 
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/authorgroup"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/authorgroup"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/author"/>

<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/author"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/author"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/othercredit"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/othercredit"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/othercredit"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/releaseinfo"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/releaseinfo"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/releaseinfo"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/copyright"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/copyright"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/copyright"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/legalnotice"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/legalnotice"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/legalnotice"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/pubdate"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/pubdate"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/pubdate"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/revision"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/revision"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/revision"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/revhistory"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/revhistory"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/revhistory"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="glossaryinfo/abstract"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="docinfo/abstract"/>
<xsl:apply-templates mode="glossary.titlepage.recto.auto.mode" select="info/abstract"/>
