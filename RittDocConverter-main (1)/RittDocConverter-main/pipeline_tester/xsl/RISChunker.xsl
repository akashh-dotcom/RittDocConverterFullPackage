...
<!--        <xsl:call-template name="search-and-replace">
    ...
    <xsl:template name="add-doctype-head">
        <xsl:text disable-output-escaping="yes">&#60;!DOCTYPE book PUBLIC &#34;-//RIS Dev//DTD DocBook V4.3 -Based Variant V1.1//EN&#34; &#34;file:///c:/Inetpub/wwwroot/dtd/v1.1/RittDocBook.dtd&#34; [</xsl:text>
    </xsl:template>
    ...
    <xsl:template name="add-entity-ref-body">
        ...
        <xsl:for-each select="book/appendix | book/toc | book/dedication | book/preface | book/part/appendix | book/part/toc | book/part/dedication | book/part/preface">
            <xsl:variable name="outFileAppendix" select="concat(name(),'.',$risisbn,'.',translate(@id,' ','_'))"/>
    ...
    <xsl:template match="book/appendix | book/toc | book/dedication | book/preface | book/part/appendix | book/part/toc | book/part/dedication | book/part/preface">
        <xsl:variable name="outFileAppendix" select="concat(name(),'.',$risisbn,'.',translate(@id,' ','_'))"/>
