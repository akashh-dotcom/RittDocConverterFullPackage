...
<!-- ## 27/02/06 Width added to show right border -->
    <table border="0" summary="Q and A Set" width="100%"> 
...
<xsl:template match="qandadiv/blockinfo/title|qandadiv/title">
  ...
  <xsl:element name="h{string(number($qalevel)+1)}">
    ...
    <!-- ## 02/03/06 Commented to Remove the Numbers(1.) of the TITLE within the QandADiv
