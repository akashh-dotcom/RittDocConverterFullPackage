...
<!-- 07-04-2006 for author tag should be docsect1Title"
	added xsl:choose and condition for prefaceinfo **xsl:when test="ancestor::prefaceinfo"**-->
  <xsl:choose>
	<xsl:when test="ancestor::prefaceinfo">
	  <!--<div font-weight="bold" hyphenate="false"><span class="docsect1Title">-->
...
<!-- <xsl:when test="ancestor::glossaryinfo"> 
	  <div font-weight="bold" hyphenate="false"><span class="docsect1Title">
		<xsl:call-template name="person.name"/></span>
		<xsl:apply-templates mode="titlepage.mode" select="./contrib"/>
		<xsl:apply-templates mode="titlepage.mode" select="./affiliation"/>
		<xsl:apply-templates mode="titlepage.mode" select="./email"/>
	  **</div>
...
<!-- ## 30-04-06 Updated for authorgroup appearing in reference -->
	<xsl:choose>
		<!--<xsl:when test="ancestor::appendixinfo">
			<xsl:call-template name="Author-formatting"><xsl:with-param name="TitleStyle">docsect1Title</xsl:with-param></xsl:call-template>
		</xsl:when>
--><!-- 20-02-2010 Updated for PartInfo move above hr line -->
		<xsl:when test="ancestor::partinfo">
			<xsl:call-template name="Author-formatting"><xsl:with-param name="TitleStyle">docsect1Title</xsl:with-param></xsl:call-template>
		</xsl:when>

	<!-- ## 26-09-07 Updated for authorgroup appearing in preface --><!--
		<xsl:when test="ancestor::prefaceinfo">
			<xsl:call-template name="Author-formatting"><xsl:with-param name="TitleStyle">docsect1Title</xsl:with-param></xsl:call-template>
		</xsl:when>

--><!-- ## 17-11-09 Updated for authorgroup appearing in glossary 
		<xsl:when test="ancestor::glossaryinfo">
			<xsl:call-template name="Author-formatting"><xsl:with-param name="TitleStyle">docsect1Title</xsl:with-param></xsl:call-template>**
		</xsl:when>--><!--
