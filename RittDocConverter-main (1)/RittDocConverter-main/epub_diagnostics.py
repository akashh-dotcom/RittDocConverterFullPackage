...
def diagnose_epub(epub_path: Path) -> dict:
    ...
    for doc in documents:
        ...
        except (UnicodeDecodeError, AttributeError, IOError) as e:
...
def main():
    ...
    if results['errors']:
        print("[ERROR] This ePub may not convert successfully")
        sys.exit(1)
    elif results['warnings']:
        print("[WARN]  This ePub may convert with some issues")
        sys.exit(0)
    else:
        print("[OK] This ePub should convert successfully")
        sys.exit(0)
