...
if /i "%choice%"=="R" (
    powershell -ExecutionPolicy Bypass -File "%~dp0clean-test-dirs-for-batch.ps1" -Recycle
) else (
    powershell -ExecutionPolicy Bypass -File "%~dp0clean-test-dirs-for-batch.ps1"
)
