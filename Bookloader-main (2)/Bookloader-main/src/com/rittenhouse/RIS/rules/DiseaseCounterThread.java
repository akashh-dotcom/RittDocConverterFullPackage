 ...
 * @author VBhatia
 */
public class DiseaseCounterThread implements Runnable {

    private LinkedHashMap diseaseMap = null;
    private String content = null;

    public DiseaseCounterThread(LinkedHashMap diseaseMap, String content) {
    ...
    public void run() {
        ...
        while (diseaseIt.hasNext()) {
            ...
            if (diseaseIndex > -1) {
                Main.foundDiseaseList.put(diseaseId, diseaseName);
            }
        }
    }
}