 ...
 * @author VBhatia
 */
public class DiseaseSynonymCounterThread implements Runnable {
    
    private LinkedHashMap diseaseMap = null;
    private String content = null;
    
    public DiseaseSynonymCounterThread(LinkedHashMap diseaseMap, String content){
    ...
    public void run() {
		...
		while (diseaseIt.hasNext()) {
			...
			if(diseaseIndex>-1){
			    Main.foundDiseaseSynList.put(diseaseId, diseaseName);
			}
		}
    }
}