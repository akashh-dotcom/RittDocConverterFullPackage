 ...
 * @author VBhatia
 */
public class DrugSynonymCounterThread implements Runnable {
    
    private LinkedHashMap diseaseMap = null;
    private String content = null;
    
    public DrugSynonymCounterThread(LinkedHashMap diseaseMap, String content){
    ...
    public void run() {
		...
		while (diseaseIt.hasNext()) {
			...
			if (diseaseIndex>-1){
			    Main.foundDrugSynList.put(diseaseId, diseaseName);
			}
		}
    }
}